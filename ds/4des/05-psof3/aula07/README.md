# Aula07 - Avaliação Prática - Sistema de Turmas e Atividades
...
|-|-|:-:|:-:|
|1|UML - Diagrama de caso de uso|Modelagem do sistema|10|
|2|Diagrama entidade relacionamento (DER)|Modelagem do banco de dados|15|
|3|Back-end com a criação e conexão com o banco de dados|Desenvolvimento do banco de dados|10|
...
### 3. Back-end com a criação e conexão com o banco de dados
...
- **[Formulário para colar o link do repositório](https://docs.google.com/forms/d/e/1FAIpQLSd8HZWp9dDd1NlHZxMu5t_cGfonRyNEYuNbmlPDmIGk6vlYqg/viewform?usp=header)**
...
### [Repositório com a Solução](https://github.com/wellifabio/escola-shadcn-2025.git)
