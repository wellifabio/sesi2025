# Aula08 - Avaliação - SAEP 2023

## Situação de Aprendizagem - Tema: Fábrica de automóveis
...
|2|Back-End, Banco de dados e Dados iniciais|Criação do banco e importação dos dados presentes nos alocacao.csv, automoveis.csv, clientes.csv e concessionarias.csv para alimentar as principais tabelas que o banco de dados deve possuir.|35|
...
Diante do cenário apresentado, você deve criar um DCU (Diagrama de Casos de Uso) que ilustre os atores, objetos e ações envolvidos no fluxo de venda de um automóvel.<br> Para isso, você deve também levar em consideração as regras de negócio detalhadas nas próximas
seções desse documento.<br>Seu diagrama de caso de uso deve ser exportado em formato *.png ou *.jpg e salvo na pasta ./docs. do seu projeto.
...
O link do repositório deve ser enviado para este **[FORM PARA ENTREGA DO PROJETO - FABICA AUTOMÓVEIS](https://docs.google.com/forms/d/e/1FAIpQLSfd1VDo3jMoeaIyRmiyERzdR83D6m0KSUU71hGKITcljydFFw/viewform?usp=publish-editor).**
...
#### [Avaliação em PDF no formato aplicado em 2023](./avaliacao.md)